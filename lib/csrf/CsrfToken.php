 ...
 * @modify por linuxknow agrega metodo checkTokenByParam($param)..
...
class CsrfToken {
    ...
    public function checkTokenByParam($csrf){
         $generatedHash = $this->calculateHash();
         $param=base64_decode($csrf);
         if ($param and $generatedHash) {
             return $param == $generatedHash;
         }
         return FALSE;
    }
